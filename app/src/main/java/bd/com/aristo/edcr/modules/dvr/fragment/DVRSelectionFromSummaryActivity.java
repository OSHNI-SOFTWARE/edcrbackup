...
public class DVRSelectionFromSummaryActivity extends AppCompatActivity {

    private final String TAG = DVRSelectionFromSummaryActivity.class.getSimpleName();
    DVRSelectionFromSummaryActivity context;
    ...
    @Inject
    Realm realm;
    int month, year, dayOfMonth, lastDay, locStatus;
    boolean isCurrent;
    ...
    public static void startFromList(Context context, int month, int year, String id, boolean isCurrent, int pos) {
        isFromList = true;
        Intent intent = new Intent(context, DVRSelectionFromSummaryActivity.class);
