...
public class AddSampleItemActivity extends AppCompatActivity {
    ...
    public static void start(Activity context, int flag){
    ...
    public void initialize(){
        ...
        if(DCRUtils.DCR_IS_INTERN){
            ...
            //productModelList = WPUtils.getMonthWiseProducts(r, DateTimeUtils.getMonthYear(dateModel.getMonth(), dateModel.getYear()));
        ...
        switch (productFlag){
            ...
            case 1:
                if(sampleModelList.size() > 0) {
                    sampleProductsList = WPUtils.getSampleModels(r, sampleModelList, dateModel);
                    refreshList();
                }
                break;
            case 2:
                if(giftModelList.size() > 0) {
                    sampleProductsList = WPUtils.getSampleGiftModels(r, giftModelList, dateModel);
                    refreshList();
                }
                break;
        }
