...
public class SampleProductAdapter extends RecyclerView.Adapter<SampleProductAdapter.MyViewHolder> {

    private final Context mContext;
    private static List<SSProductModel> mData;

    public SampleProductAdapter(Context context) {
        mContext = context;
        mData = new ArrayList<>();
    }
    ...
    public void updateSampleProduct(List<SSProductModel> pList){
        mData.addAll(pList);
