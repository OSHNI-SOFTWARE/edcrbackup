...
public class IPlacesModel implements IItem<IPlacesModel, IPlacesModel.ViewHolder> {
    ...
    @Override
    public IPlacesModel withTag(Object tag) {
        this.tag = tag;
        return this;
    }
    ...
    @Override
    public IPlacesModel withEnabled(boolean enabled) {
    ...
    @Override
    public IPlacesModel withSetSelected(boolean selected) {
        isSelected = selected;
        return this;
    }
    ...
    @Override
    public IPlacesModel withSelectable(boolean selectable) {
...
//        SystemUtils.log("on bind view");
    ...
    @Override
    public IPlacesModel withIdentifier(long identifier) {
        return null;
    }
