...
public class SSProductAdapter extends RecyclerView.Adapter<SSProductAdapter.MyViewHolder> {

    private final Context mContext;
    private static List<SSProductModel> mData;

    public SSProductAdapter(Context context) {
        mContext = context;
        mData = new ArrayList<>();
    }
    ...
    public void updateSelectiveProduct(List<SSProductModel> pList){
        mData.addAll(pList);
