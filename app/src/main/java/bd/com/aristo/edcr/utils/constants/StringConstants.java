...
public class StringConstants {
    ...
    public static String IS_DCR_SYNCED_SUCCESS                    = "isDCRSynced";
    public static String PERMISSION_NEED                          = "Permission needed!!";
    public static String PREF_AUTH_TOKEN                          = "pref_auth_token";
    public static String IS_PRODUCT_SYNCED                        = "isProductSynced";
    public static String IS_SYNCED_SUCCESS                        = "isSyncNeed";
    ...
    public static String TP_DVR_PWDS_GWDS_SYNCED_WITH_CHANGES     = "TP, DVR, PWDS, GWDS may changes after synced. Do you confirm?";
    public static String DELETE_ALL_ALERT                         = "All EDCR data saved in mobile will be cleared. Do you confirm to clear?";
    public static String TP_CHANGE_ALERT                          = "Are you sure want to change tour plan";
    public static String TP_CHANGE_PENDING_DVR_ALERT              = "DVR is waiting. You can change TP after DVR approved.";
    ...
    final public static String MORNING                            = "m"; //"Morning" "m"
    final public static String CAPITAL_MORNING                    = "MORNING"; //"Morning" "m"
    final public static String EVENING                            = "e"; //"Evening" "e"
    final public static String CAPITAL_EVENING                    = "EVENING"; //"Evening" "e"
    ...
    public static String PWDS                                     = "PWDS";
