...
public class GWDSGiftModel implements IItem<GWDSGiftModel, GWDSGiftModel.ViewHolder>{
...
//    protected long uniqueID = -1;
    ...
    @Override
    public GWDSGiftModel withTag(Object tag) {
        this.tag = tag;
        return this;
    }
    ...
    @Override
    public GWDSGiftModel withEnabled(boolean enabled) {
        return null;
    }
    ...
    @Override
    public GWDSGiftModel withSetSelected(boolean selected) {
        return null;
    }
    ...
    @Override
    public GWDSGiftModel withSelectable(boolean selectable) {
    ...
    public int getLayoutRes() {
        return R.layout.item_gwds_product;
    }
    ...
    public void bindView(ViewHolder holder, List<Object> payloads) {
        ...
        holder.planned.setText("Plan doc: "+planned);
        holder.itemView.setSelected(isSelected());

        Context ctx = holder.itemView.getContext();
        if(planned > 0){
            if(isApproved){
                holder.itemRowLayout.setBackgroundColor(SystemUtils.getColorFromID(ctx, R.color.blue_light));
    ...
    @Override
    public GWDSGiftModel withIdentifier(long identifier) {
