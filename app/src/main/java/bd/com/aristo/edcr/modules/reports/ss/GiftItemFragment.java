...
public class GiftItemFragment extends Fragment {
    ...
    public static GiftItemFragment newInstance(int m, int y) {
        month = m;
        year = y;
    ...
    private void refreshList(){
        //List<ItemStatementModel> itemStatementModels = SampleUtils.getItemStatementList(r,StringConstants.GIFT_ITEM, StringConstants.ITEM_FOR_REGULAR);
        SampleStatementResponse sampleStatementResponse = SampleStatementResponse.getInstance();
        List<SampleStatementModel> itemStatementModels = sampleStatementResponse.getSampleStatementModelList(StringConstants.GIFT_ITEM, StringConstants.ITEM_FOR_REGULAR);
                ...
                .subscribeWith(new DisposableObserver<ResponseDetail<ItemExecuteModel>>() {
                    ...
                    public void onNext(ResponseDetail<ItemExecuteModel> value) {
                        if (value.getStatus()!=null && value.getStatus().equals("True")) {
                            ...
                            StatementDialogFragment newFragment = StatementDialogFragment.newInstance(pName,StringConstants.GIFT_ITEM);
