...
import bd.com.aristo.edcr.modules.dvr.fragment.OnDoctorClickListener;
...
public class IDVRSummaryModel implements IItem<IDVRSummaryModel, IDVRSummaryModel.ViewHolder> {
    ...
    public OnDoctorClickListener getOnDoctorClickListener() {
        return onDoctorClickListener;
    }
    ...
    public void bindView(final ViewHolder holder, List<Object> payloads) {
        ...
        fastAdapterEvening.withOnClickListener(new FastAdapter.OnClickListener<IDVRDoctors>() {
            ...
            public boolean onClick(View v, IAdapter<IDVRDoctors> adapter, IDVRDoctors item, int position) {
                onDoctorClickListener.onDoctorClick(holder.getAdapterPosition());
                DVRSelectionFromSummaryActivity.startFromList(ctx, month, year, item.getId(), isCurrentMonth, holder.getAdapterPosition());
                return false;
            }
        });
