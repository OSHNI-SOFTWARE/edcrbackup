...
public class DCRDoctorUnplanModel implements IItem<DCRDoctorUnplanModel, DCRDoctorUnplanModel.ViewHolder> {
    ...
    @Override
    public DCRDoctorUnplanModel withTag(Object tag) {
        this.tag = tag;
        return this;
    }
    ...
    @Override
    public DCRDoctorUnplanModel withEnabled(boolean enabled) {
    ...
    @Override
    public DCRDoctorUnplanModel withSetSelected(boolean selected) {
        isSelected = selected;
        return this;
    }
    ...
    @Override
    public DCRDoctorUnplanModel withSelectable(boolean selectable) {
...
//        SystemUtils.log("on bind view");
    ...
    @Override
    public DCRDoctorUnplanModel withIdentifier(long identifier) {
        return this;
    }
