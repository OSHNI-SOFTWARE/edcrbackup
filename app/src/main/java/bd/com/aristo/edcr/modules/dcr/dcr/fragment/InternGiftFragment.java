...
public class InternGiftFragment extends Fragment {
    ...
    @SuppressLint("ValidFragment")
    public InternGiftFragment(DCRProductListener dcrProductListener) {
    ...
    private void setupList() {
        giftModelList = WPUtils.getMonthWiseGiftsForIntern(r, dateModel.getYear(), dateModel.getMonth());
        if(giftModelList.size() > 0)  { //doctors available, load list
            //DCRUtils.setDCRGiftList(r, 3);
            refreshList();
    ...
    private void refreshList(){
        //productsModels = DCRUtils.getDCRGiftList(r, 3);
        productsModels = dcrProductListener.getDCRRefreshList(2);//DCRUtils.getDCRSampleRefreshList(r, 3);
        //List<IDCRProductsModel> productsModels = DCRUtils.getDcrGiftList(r);
