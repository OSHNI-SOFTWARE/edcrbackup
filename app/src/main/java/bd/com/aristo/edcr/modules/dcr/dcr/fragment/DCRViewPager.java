...
import bd.com.aristo.edcr.listener.GetProductResponseListener;
...
public class DCRViewPager extends Fragment implements UploadSaveListener, DCRSenderListener, GetProductResponseListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        /*if(ConnectionUtils.isNetworkConnected(context)){
            requestServices.getProductAfterDCR(context, apiServices, userModel.getUserId(), r, this);
        } else {
            populateData();
        }*/
        return rootView;
    ...
    private void setupTabs() {
        ...
        mSectionsPagerAdapter = new DCRViewPager.SectionsPagerAdapter(getChildFragmentManager());
    ...
    public void showPopupAbsentOptions(){
        try {
            ...
            final View layout = inflater.inflate(R.layout.pop_up_absent, (ViewGroup) activity.findViewById(R.id.popup));
    ...
    public void uploadDCR(final String remarks){
        ...
        dcrSendModel.setRemarks(remarks);
        ...
        //DCRSender.uploadDCR(this, dcrSendModel,  ((Activity) context), apiServices, dcrModelForSendList);
