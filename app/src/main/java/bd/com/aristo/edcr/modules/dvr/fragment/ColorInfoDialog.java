...
public class ColorInfoDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View v = ((Activity) context).getLayoutInflater().inflate(R.layout.fragment_dialog_color_info_dvr, null);
