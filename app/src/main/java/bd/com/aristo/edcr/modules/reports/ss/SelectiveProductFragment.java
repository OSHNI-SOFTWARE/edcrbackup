...
public class SelectiveProductFragment extends Fragment{
    ...
    private final String TAG = SelectiveProductFragment.class.getSimpleName();
   ...
   public static ArrayList<ItemExecuteModel> itemExecuteModelList = new ArrayList<>();
    ...
    public static SelectiveProductFragment newInstance(int m, int y) {
        month = m;
        year = y;
        SelectiveProductFragment spf = new SelectiveProductFragment();
        return spf;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView                                   = inflater.inflate(R.layout.fragment_selective_product, container, false);
    ...
    private void refreshList(){
        ...
        //List<ItemStatementModel> itemStatementModels = SampleUtils.getItemStatementList(r,StringConstants.SELECTED_ITEM, StringConstants.ITEM_FOR_REGULAR);
        //List<ItemStatementModel> itemStatementModels = SampleUtils.getItemStatementList(StringConstants.SELECTED_ITEM, StringConstants.ITEM_FOR_REGULAR);
        List<SampleStatementModel> itemStatementModels = sampleStatementResponse.getSampleStatementModelList(StringConstants.SELECTED_ITEM, StringConstants.ITEM_FOR_REGULAR);
                ...
                .subscribeWith(new DisposableObserver<ResponseDetail<ItemExecuteModel>>() {
                    ...
                    public void onNext(ResponseDetail<ItemExecuteModel> value) {
                        if (value.getStatus()!=null && value.getStatus().equals("True")) {
                            ...
                            try {
                                StatementDialogFragment newFragment = StatementDialogFragment.newInstance(pName,StringConstants.SELECTED_ITEM);
