...
public class PWDSDoctorsModel implements IItem<PWDSDoctorsModel, PWDSDoctorsModel.ViewHolder> {

    private static String TAG   ="PWDSDoctorsModel";
    public String id;
    private String name, degree, special, address;
    private boolean isSaved, isSynced;
    private boolean isPwds;

    //store column names here
    @Ignore
    public static String COL_ID = "id", COL_NAME = "date", COL_CLICKED = "clickCount", COL_INST = "inst";
    ...
    public void setPwds(boolean pwds) {
        isPwds = pwds;
    }
    ...
    public boolean equals(Object o) {
        ...
        PWDSDoctorsModel that = (PWDSDoctorsModel) o;
    ...
    @Override
    public PWDSDoctorsModel withTag(Object tag) {
        this.tag = tag;
        return this;
    }
    ...
    @Override
    public PWDSDoctorsModel withEnabled(boolean enabled) {
    ...
    @Override
    public PWDSDoctorsModel withSetSelected(boolean selected) {
    ...
    @Override
    public PWDSDoctorsModel withSelectable(boolean selectable) {
...
//        SystemUtils.log("on bind view");
    ...
    @Override
    public PWDSDoctorsModel withIdentifier(long identifier) {
        return null;
    }
