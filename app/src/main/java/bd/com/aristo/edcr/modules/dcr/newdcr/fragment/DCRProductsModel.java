...
public class DCRProductsModel implements IItem<DCRProductsModel, DCRProductsModel.ViewHolder>{
...
//    protected long uniqueID = -1;
    ...
    @Override
    public DCRProductsModel withTag(Object tag) {
        this.tag = tag;
        return this;
    }
    ...
    @Override
    public DCRProductsModel withEnabled(boolean enabled) {
        return null;
    }
    ...
    @Override
    public DCRProductsModel withSetSelected(boolean selected) {
        return null;
    }
    ...
    @Override
    public DCRProductsModel withSelectable(boolean selectable) {
    ...
    @Override
    public DCRProductsModel withIdentifier(long identifier) {
